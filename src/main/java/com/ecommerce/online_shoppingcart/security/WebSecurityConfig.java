package com.ecommerce.online_shoppingcart.security;
...
import com.ecommerce.online_shoppingcart.security.jwt.AuthEntryPointJwt;
import com.ecommerce.online_shoppingcart.security.jwt.AuthTokenFilter;
import com.ecommerce.online_shoppingcart.security.services.UserDetailsServiceImpl;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/public/products/search/**").permitAll()
